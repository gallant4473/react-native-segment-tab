...
export default class extends Component {
  ...
  renderTabOption (tab, index) {
    ...
    const buttonStyle= this.props.buttonstyle? this.props.buttonstyle : {}
    ...
    return (
      <TouchableOpacity key={index}
        ...
        activeOpacity={1}
        style={[styles.item, {backgroundColor: (isTabActive ? activeColor : inActiveColor), borderColor: activeColor}, ...itemStyle,...buttonStyle]}>
  ...
  render () {
    ...
    : [{width: verticalWidth, height: verticalHeight, flexDirection: 'column'},extraStyle]
    return (
      <ScrollView style={[...style, {backgroundColor: 'transparent'}, {borderWidth: 0}, this.props.style]}>
